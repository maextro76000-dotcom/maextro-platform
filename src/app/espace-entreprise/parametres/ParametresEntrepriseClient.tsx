...
export default function ParametresEntrepriseClient({ email }: { email: string }) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-2xl border border-gray-100 p-6">
        ...
        <div className="space-y-4">
          {[
            { label: "Notifications par email", desc: "Confirmations, factures, rappels événements", value: notifEmail, onChange: setNotifEmail },
            ...
            <div key={n.label} className="flex items-center justify-between py-2">
              ...
              <button onClick={() => n.onChange(!n.value)}
